...
export const Modals: FC<modalProps> = ({
  no,
  tombol1,
  tombol2,
  titleModal,
    ...
    <>
      ...
      <div className="modal modal-middle sm:modal-middle">
        <div className="modal-box bg-white  flex flex-col justify-center items-center">
          <h3 className="font-bold lg:text-2xl  text-base text-[#38E54D] text-center  ">
            {titleModal}
          </h3>
          {input1}
          {input2}
          ...
          <div className="grid grid-cols-2 w-2/3 md:w-full lg:w-full max-w-md mt-3">
            <label
              htmlFor={`my-modal-${no}`}
              className="btn bg-[#38E54D] normal-case border-none mx-1 hover:bg-green-800 text-white"
            >
              {tombol1}
            </label>
            ...
            <label
              htmlFor={`my-modal-${no}`}
              className="btn bg-[#38E54D] normal-case  border-none mx-1 hover:bg-green-700 text-white"
              onClick={onClick}
            >
              {tombol2}
            </label>
    ...
    <>
      ...
      <div className="modal modal-middle sm:modal-middle">
        <div className="modal-box bg-white  flex flex-col justify-center items-center">
          ...
          {input3}
          {input4}
          <div className="grid grid-rows-2 w-2/3 md:w-full lg:w-full max-w-md mt-3">
            <label
              htmlFor={`my-modal-${no}`}
              className="btn bg-[#38E54D] normal-case border-none mx-1 hover:bg-green-800 text-white"
            >
