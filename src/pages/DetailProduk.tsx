        ...
        <div className="flex flex-row justify-between">
          ...
          <div className="basis-1/2">
            ...
            <p>
              ...
              nisl elit, lacinia eu porta non, dictum ut nisl.
            </p>
            ...
            <div className="flex justify-end gap-5 mt-10">
              ...
              >
                <i className="fa-solid fa-right-to-bracket"></i>&nbsp;&nbsp;Beli
                Sekarang
              </button>
              <button
                type="submit"
        ...
        <div className="mt-20">
          ...
          <div className="px-10 py-5">
            ...
            <p>
              ...
              ipsam labore adipisci, explicabo voluptates est necessitatibus
              itaque temporibus aperiam ab delectus nihil praesentium dolores at
              qui veritatis ad harum soluta eaque illo dignissimos laudantium!
              Animi saepe illo ipsam est optio odit quo placeat? Dolor
              blanditiis eaque quam maxime earum.
            </p>
          </div>
        </div>
        <div className="mt-10">
          ...
          <div className="px-10 py-5">
            <p>
              GARANSI UANG KEMBALI 100% apabila barang yang kami kirim berbeda
              dengan barang yang anda pesan atau berbeda dengan foto produk
            </p>
          </div>
        </div>
      </div>
