      ...
      <div className="w-auto p-20 m-20 bg-white ">
        ...
        <div className="flex flex-row mt-5 p-10 border-t-2 border-b-2">
          <div className="basis-1/2">
            ...
            <p>0812345678910</p>
            <p>Jl. Garuda Jaya no 85B, Surakarta, Jawa Tengah 57792</p>
          </div>
          <div className="basis-1/2 text-end">
            ...
            >
              <i className="fa-solid fa-right-to-bracket"></i>&nbsp;&nbsp;Ubah
              Alamat
            </button>
          </div>
        </div>
            ...
            <div className="flex flex-row">
              <div className="basis-1/2">
                <div className="flex gap-5 items-center">
                  ...
                  />
                  <span className="label-text font-bold">Gratis Ongkir</span>
                </div>
                <p className="mt-5 ml-10">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec
                  nisl elit, lacinia eu porta non, dictum ut nisl. Morbi auctor
                  orci id justo congue, eu pretium neque tincidunt.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="basis-full">
            <div className="flex flex-row mt-5 justify-end gap-5">
              <div className="basis-1/4 font-bold">
                <button
                  type="submit"
                  className="border-2 border-red-600 bg-white text-red-600 px-3 py-3 w-full rounded-md hover:bg-transparent hover:text-red-800 font-semibold"
                >
              ...
              <div className="basis-1/4 text-right font-bold">
                <button
                  type="submit"
                  className="border-2 border-[#38E54D] bg-[#38E54D] text-white px-3 py-3 w-full rounded-md hover:bg-transparent hover:text-[#38E54D] font-semibold"
                >
                  <i className="fa-solid fa-right-to-bracket"></i>
                  &nbsp;&nbsp;Bayar Sekarang
                </button>
